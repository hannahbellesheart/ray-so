// AI Prompts Data - Extracted from ray.so source (84 prompts)
const promptsData = [
  {
    id: "inspect-website",
  ...
  },
  {
    ...
    prompt: "Convert the HTML code to Markdown.\n\nHTML code: {selection}\n\nMarkdown:",
    icon: "code",
    creativity: "none",
    date: "2023-06-06",
  },
  ...
  },
  {
    ...
    prompt: "Translate the text in {argument name=language}.\n\nText: {selection}\n\nTranslation:",
    icon: "speech-bubble",
    creativity: "low",
    date: "2023-06-06",
  },
  ...
  },
  {
    ...
    prompt: "Please summarize and omit the following. Then express your empathy.\n\nText: {selection}\n\nSympathy:",
    icon: "speech-bubble",
    creativity: "low",
    date: "2023-06-12",
  },
  ...
  },
  {
    id: "drunkgpt",
    title: "DrunkGPT",
    prompt: "Rewrite the text as if you were drunk.\n\nText: {selection}\n\nRewritten text:",
